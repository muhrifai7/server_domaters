...
let ArticleRepository = class ArticleRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Article, dataSource);
    }
};
ArticleRepository = tslib_1.__decorate([
